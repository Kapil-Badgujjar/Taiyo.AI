            ...
            <div>
                ...
                {myQuery.data && (
                    <div className='flex flex-wrap gap-4 text-white p-2'> {/* applying tailwind class for styling */}
                        <div className="bg-yellow-600 p-4 border-2 border-slate-100">
                        ...
                        <div className='bg-red-600 p-4 border-2 border-slate-100'>
                        ...
                        <div className='bg-green-600 p-4 border-2 border-slate-100'>
                        ...
                        <div className='bg-blue-600 p-4 border-2 border-slate-100'>
                        ...
                        <div className='bg-orange-600 p-4 border-2 border-slate-100'>
                        ...
                        <div className='bg-red-500 p-4 border-2 border-slate-100'>
                        ...
                        <div className='bg-slate-400 p-4 border-2 border-slate-100'>
